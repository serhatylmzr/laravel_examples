public function addArticle(Request $request){
        ...
        try{
                ...
                if ($request->article_rank == null || is_numeric($request->article_rank)) {
                    if($request->code_text == null){
                      $code_text = null;
                        ...
                        return response(['status' => 'success', 'title' => 'Başarılı', 'content' => 'Başarıyla Kaydedildi']);
                } else {
                    return response([
                        'status' => 'error',
                        'title' => 'Hata',
            ...
            return response(['status' => 'error', 'title' => 'Hata', 'content' => 'Kayıt'. str_limit($e,200) . 'Hatasından Dolayı Yapılamadı']);
        }
